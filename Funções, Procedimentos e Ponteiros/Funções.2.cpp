...
int validacao (int limite); //Prototipo declara somente o cabeÃ§alho.
...
int main()
{
    ...
    nPessoas = 85;	//nPessoas: Variavel local ao main
    solteiroSuperior = 0;
    cout<<"\nEntre com os dados das "<<qtde<<" pessoas, conforme as opções listadas:\n";
    for(int nPessoas=1; nPessoas<=qtde; nPessoas++) //nPessoas: Variavel local do for
    {
    ...
    cout<<"\nTotal de pessoas: "<<nPessoas<<endl;	
