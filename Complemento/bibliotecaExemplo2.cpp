//
//  bibliotecaExemplo2.cpp
//
//
//  Created by Nagela Bittar & Pedro Valle on 19/09/16
//
//
//  Cria uma biblioteca com 2 arquivos: um ".h" e outro ".cpp"
//  Corrigido
//  utilizando o exemplo TAD dia da semana
//  Facilita o reuso, manutenção e clareza do código fonte 
//
#include <iostream>
using std::cerr;
using std::cin;
...
#include "semana2.h" /* inclui o código da biblioteca criada, 
